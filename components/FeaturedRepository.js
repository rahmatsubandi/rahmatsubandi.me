...
import { YoutubeIcon, GithubIcon } from "./CustomIcons";
import { ExternalLinkIcon } from "@chakra-ui/icons";
import { AiOutlineStar } from "react-icons/ai";

export default function FeaturedRepository({
    title,
    description,
    repoHref,
    demoHref,
    ...
    const [lineColor, setLineColor] = useState("green.500");
    ...
    return (
        <Flex
            ...
            onMouseLeave={() => {
                setOpacity(0), setLineColor("green.600");
            }}
        >
