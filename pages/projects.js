...
const url = "https://www.rahmatsubandi.dev/projects";
      ...
      <Container>
        ...
        >
          ...
          >
            ...
            <Divider mb={5} mt={5} w="50%" alignSelf="center" />

            <Heading letterSpacing="tight" as="h3" size="lg" fontWeight={700}>
              Latest Projects
            </Heading>
            ...
            <Heading letterSpacing="tight" as="h2" size="lg" fontWeight={700}>
              Learning Projects
            </Heading>
